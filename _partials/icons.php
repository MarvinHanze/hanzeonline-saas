...
/**
 * Kleine gedeelde iconenset (inline SVG, geen icon-font/CDN nodig) gebruikt door
 * de sidebar-navigatie en module-kaarten. Namespace-vrij stukje procedurele code
 * (geen class nodig) — bewust simpel gehouden.
 */
if (!function_exists('hz_icon')) {
    function hz_icon(string $key, string $class = 'hz-icon'): string
    {
        ...
        return '<svg class="' . htmlspecialchars($class) . '" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round">' . $path . '</svg>';
    }
}
