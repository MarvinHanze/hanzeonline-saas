...
<div class="hz-card" style="max-width:520px;">
    <form method="post" action="<?= BASE ?>/beheer/branding" enctype="multipart/form-data">
        <div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.25rem;">
            ...
            <?php endif; ?>
            <div>
                <label for="logo" style="display:block;font-size:.85rem;font-weight:600;margin-bottom:.35rem;">Logo (PNG/JPG/SVG/WebP, max 2MB)</label>
