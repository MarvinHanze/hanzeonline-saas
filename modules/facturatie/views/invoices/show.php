        ...
        <div class="flex-1 lg:ml-64">
            <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between lg:px-8">
                ...
                <div class="flex gap-2">
                    <a href="/facturatie/facturen/<?= $invoice['id'] ?>/pdf" class="inline-flex items-center gap-1.5 text-sm font-medium text-gray-600 border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50">
            ...
            <main class="p-4 lg:p-8">
                <div class="max-w-4xl">
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
                        <div class="flex flex-col md:flex-row md:justify-between md:items-start gap-4 mb-6">
                            ...
                            <div class="flex items-center gap-2">
                                <form method="POST" action="/facturatie/facturen/<?= $invoice['id'] ?>/status" class="flex gap-2">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="/facturatie/facturen/<?= $invoice['id'] ?>/pdf" class="inline-flex items-center gap-2 bg-white border border-gray-300 text-gray-700 text-sm font-medium px-5 py-2.5 rounded-lg hover:bg-gray-50">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                            PDF downloaden
                        </a>
                        <form method="POST" action="/facturatie/facturen/<?= $invoice['id'] ?>/herinnering" class="inline">
