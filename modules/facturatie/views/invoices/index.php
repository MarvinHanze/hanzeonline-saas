    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 lg:ml-64">
            <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between lg:px-8">
                ...
                <a href="/facturatie/facturen/nieuw" class="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-lg">
            ...
            <main class="p-4 lg:p-8">
                ...
                <div class="flex flex-wrap gap-2 mb-6">
                    ...
                    ?>
                    <a href="/facturatie/facturen<?= $val ? "?status=$val" : '' ?>" class="px-4 py-2 rounded-lg text-sm font-medium <?= $currentStatus === $val ? 'bg-blue-500 text-white' : 'bg-white border border-gray-200 text-gray-600 hover:bg-gray-50' ?>"><?= $label ?></a>
                    <?php endforeach; ?>
                </div>

                <!-- Search -->
                <form method="GET" action="/facturatie/facturen" class="mb-6">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="/facturatie/facturen/<?= $inv['id'] ?>" class="text-gray-400 hover:text-blue-500">
