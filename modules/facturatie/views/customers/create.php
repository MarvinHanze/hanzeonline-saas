    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 lg:ml-64">
            ...
            <main class="p-4 lg:p-8">
                <form method="POST" action="<?= BASE ?>/facturatie/klanten" class="max-w-3xl"><?= \Core\Csrf::field() ?>
                    ...
                    <div class="mt-6 flex gap-3">
                        ...
                        <a href="<?= BASE ?>/facturatie/klanten" class="bg-white border border-gray-300 text-gray-700 text-sm font-medium px-6 py-2.5 rounded-lg hover:bg-gray-50">Annuleren</a>
                    </div>
                </form>
            </main>
        </div>
