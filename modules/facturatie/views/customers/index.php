    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 lg:ml-64">
            <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between lg:px-8">
                ...
                <a href="<?= BASE ?>/facturatie/klanten/nieuw" class="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium px-4 py-2 rounded-lg">
            ...
            <main class="p-4 lg:p-8">
                <!-- Search -->
                <form method="GET" action="<?= BASE ?>/facturatie/klanten" class="mb-6">
                        ...
                        <table class="w-full text-sm">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <a href="<?= BASE ?>/facturatie/klanten/<?= $customer['id'] ?>" class="font-medium text-blue-600 hover:text-blue-700"><?= htmlspecialchars($customer['name']) ?></a>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="<?= BASE ?>/facturatie/klanten/<?= $customer['id'] ?>" class="text-gray-400 hover:text-blue-500">
