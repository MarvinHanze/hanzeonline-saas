        ...
        <div class="flex-1 lg:ml-64">
            <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between lg:px-8">
                ...
                <div class="flex gap-2">
                    <a href="/facturatie/klanten/<?= $customer['id'] ?>/bewerk" class="text-sm text-gray-600 hover:text-gray-900 border border-gray-300 px-4 py-2 rounded-lg font-medium">Bewerken</a>
                </div>
            </header>
            ...
            <main class="p-4 lg:p-8">
                ...
                <div class="bg-white rounded-xl border border-gray-200">
                    <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                        ...
                        <a href="/facturatie/facturen/nieuw" class="text-sm text-blue-600 hover:text-blue-700 font-medium">+ Nieuwe factuur</a>
                    </div>
