...
<div class="min-h-full flex">
    ...
    <div class="flex-1 lg:ml-64">
        <header class="bg-white border-b border-slate-200 h-16 flex items-center px-4 sm:px-6 lg:px-8">
            ...
            <a href="/hr/medewerkers/<?= $employee['id'] ?>" class="text-slate-400 hover:text-slate-600 mr-3">
        ...
        <main class="p-4 sm:p-6 lg:p-8 max-w-2xl">
            <form method="POST" action="/hr/medewerkers/<?= $employee['id'] ?>" class="bg-white rounded-xl border border-slate-200 p-6 space-y-5">
                <div>
                ...
                <div class="flex gap-3 pt-2">
                    ...
                    <a href="/hr/medewerkers/<?= $employee['id'] ?>" class="px-5 py-2 bg-slate-100 text-slate-700 text-sm font-medium rounded-lg hover:bg-slate-200">Annuleren</a>
                </div>
            </form>
        </main>
    </div>
