...
<div class="min-h-full flex">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white border-r border-slate-200 z-40 transform -translate-x-full lg:translate-x-0 transition-transform">
        ...
        <nav class="p-4 space-y-1">
            <a href="<?= BASE ?>/hr" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50">
            ...
            <a href="<?= BASE ?>/hr/medewerkers" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium bg-emerald-50 text-emerald-700">
            ...
            <a href="<?= BASE ?>/hr/verlof" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50">
            ...
            <a href="<?= BASE ?>/hr/organogram" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50">
            ...
            <a href="<?= BASE ?>/hr/beoordelingen" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-50">
    ...
    <div class="flex-1 lg:ml-64">
        <header class="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <a href="<?= BASE ?>/hr/medewerkers/nieuw" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white text-sm font-medium rounded-lg hover:bg-emerald-700">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            ...
                            <?php else: foreach ($employees as $emp): ?>
                                <tr class="hover:bg-slate-50">
                                    <td class="px-5 py-3">
                                        <a href="<?= BASE ?>/hr/medewerkers/<?= $emp['id'] ?>" class="font-medium text-slate-900 hover:text-emerald-600"><?= htmlspecialchars($emp['name']) ?></a>
                                    </td>
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <a href="<?= BASE ?>/hr/medewerkers/<?= $emp['id'] ?>/bewerk" class="text-emerald-600 hover:text-emerald-800 text-sm font-medium">Bewerken</a>
                                    </td>
                                </tr>
