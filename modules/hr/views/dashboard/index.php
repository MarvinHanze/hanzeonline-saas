...
<div class="min-h-full flex">
    ...
    <aside id="sidebar" class="fixed inset-y-0 left-0 w-64 bg-white border-r border-slate-200 z-40 transform -translate-x-full lg:translate-x-0 transition-transform">
        ...
        <nav class="p-4 space-y-1">
            <a href="/hr" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium <?= $currentPage === 'dashboard' ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50' ?>">
            ...
            <a href="/hr/medewerkers" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium <?= $currentPage === 'employees' ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50' ?>">
            ...
            <a href="/hr/verlof" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium <?= $currentPage === 'leave' ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50' ?>">
            ...
            <a href="/hr/organogram" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium <?= $currentPage === 'departments' ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50' ?>">
            ...
            <a href="/hr/beoordelingen" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium <?= $currentPage === 'reviews' ? 'bg-emerald-50 text-emerald-700' : 'text-slate-600 hover:bg-slate-50' ?>">
    ...
    <div class="flex-1 lg:ml-64">
        <header class="bg-white border-b border-slate-200 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8">
            ...
            <a href="/" class="text-sm text-slate-500 hover:text-slate-700">Hoofdmenu</a>
        </header>
