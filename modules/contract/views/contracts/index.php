    ...
    <main class="flex-1 lg:ml-64 pt-16 lg:pt-0">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
                ...
                <a href="/contract/contracts/nieuw" class="inline-flex items-center gap-2 px-4 py-2 bg-brand-500 text-white rounded-lg text-sm font-medium hover:bg-brand-600 transition-colors">
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                <?php foreach ($tabs as $val => $label): ?>
                    <a href="/contract/contracts<?= $val ? "?status=$val" : '' ?>"
