...
<div class="min-h-full flex">
    ...
    <main class="flex-1 lg:ml-64 pt-16 lg:pt-0">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <form method="POST" action="/contract/contracts" class="space-y-6">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="/contract/contracts" class="px-5 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                        Annuleren
                    </a>
                </div>
            </form>
