...
<div class="min-h-full flex">
    ...
    <aside id="sidebar" class="hidden lg:flex lg:flex-col w-64 bg-white border-r border-slate-200 fixed inset-y-0 left-0 z-30">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1">
            ...
            <a href="/contract/contracts" class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium bg-brand-50 text-brand-700">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <?php if ($hasSignature): ?>
                <div class="bg-white rounded-xl border border-slate-200 p-6 mb-6">
                    ...
                    <?php if ($signaturePath && file_exists($signaturePath)): ?>
                        <img src="/<?= ltrim($signaturePath, __DIR__ . '/../../../') ?>" alt="Handtekening" class="max-w-xs border border-slate-200 rounded-lg">
                    <?php else: ?>
            ...
            <?php else: ?>
                ...
                <div class="bg-white rounded-xl border border-slate-200 p-6 mb-6">
                    ...
                    <form method="POST" action="/contract/contracts/<?= $contract['id'] ?>/ondertekenen">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <a href="/contract/contracts/<?= $contract['id'] ?>/pdf" class="px-4 py-2.5 bg-white border border-slate-200 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors inline-flex items-center gap-2">
                ...
                <div class="relative inline-block">
                    ...
                    <form id="statusForm" method="POST" action="/contract/contracts/<?= $contract['id'] ?>/status" class="hidden absolute top-full left-0 mt-2 bg-white border border-slate-200 rounded-lg shadow-lg p-3 z-10">
